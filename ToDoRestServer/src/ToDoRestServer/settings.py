...
DATABASES = {
    'default': {
        ...
        'NAME': SRC_ROOT + '/todos.db',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = 'u^3kip-zx=bx&amp;uju$^=msjf$2e%b6-*ihm01gj352(u4&amp;^53_4'
...
ROOT_URLCONF = 'ToDoRestServer.urls'
